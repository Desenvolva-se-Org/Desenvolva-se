    ...
    <div className="about-wrapper">
        ...
        <div className="about-container text-center">
          ...
          <div className="about-hero-header mb-6 md:mb-8">
            ...
            <h1 className="about-title">
              <img src={LogoIcon} alt="Ícone Desenvolva-se" className="about-logo" /> 
      ...
      <section className="about-content-section">
        <div className="about-container">
          ...
          {/* Bloco de Visão */}
          <div className="about-block text-center mb-12 md:mb-16">
          ...
          <div className="about-block text-center">
            ...
            <div className="values-grid">
              ...
              <div className="value-card">
                ...
                <p className="value-text">Usamos tecnologia de ponta para resolver problemas reais de carreira.</p>
              </div>
              ...
              <div className="value-card">
                ...
                <p className="value-text">O conhecimento deve ser acessível a todos que buscam crescer.</p>
              </div>
              ...
              <div className="value-card">
                ...
                <p className="value-text">Incentivamos a aprendizagem ao longo da vida (lifelong learning).</p>
              </div>
